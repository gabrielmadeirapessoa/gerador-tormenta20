...
function pickDeus(devoto) {
    var deuses = [
        ...
        { key: "Azgher", r: ["Hu", "Qa"], c: ["Ar", "Ba", "Ca", "Cl", "Cv", "Ge", "No", "Pa"] },
        { key: "Hyninn", r: ["Gb", "Hu", "Hy"], c: ["Bd", "Bu", "Cl", "In", "La", "No"] },
        ...
        { key: "Megalokk", r: ["Gb", "Hu", "Me", "Mi", "Tr"], c: ["Ba", "Ca", "Cl", "Dr", "Lu"] },
        { key: "Nimb", r: ["Gb", "Hu", "Qa"], c: ["Ba", "Bd", "Bu", "Cl", "In", "La"] },
        { key: "Oceano", r: ["Da", "Hu", "Hy", "Mi", "Ts"], c: ["Ba", "Bu", "Ca", "Cl", "Dr"] },
        { key: "Sszzaas", r: ["Hu", "Me"], c: ["Ar", "Bd", "Bu", "Cl", "In", "La", "No"] },
        { key: "Tanna-Toh", r: ["Gl", "Hu", "Kl"], c: ["Ar", "Bd", "Cl", "In", "No", "Pa"] },
        { key: "Tenebra", r: ["An", "Hu", "Os", "Qa", "Tr"], c: ["Ar", "Bd", "Cl", "La"] },
        { key: "Thwor", r: [], c: [] },
